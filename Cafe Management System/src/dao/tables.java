...
public class tables {
    public static void main(String[] args) {
        try{
            ...
            String billTable = "create table bill( id int primary key, name varchar(200),moblileNumber varchar(200),email varchar(200),date varchar(200),total varchar(200), createdBy varchar(200))";
